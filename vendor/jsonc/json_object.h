...
/** Get string of json_object
 *
 * @param obj the json_object instance
 * @param key this value's key in json_object
 * @returns const char* of key value , if no find , NULL will be return
 */
extern const char* json_object_object_get_string( struct json_object *obj , const char* key );

/** Get int-64 of json_object
 *
 * @param obj the json_object instance
 * @param key this value's key in json_object
 * @param value this value
