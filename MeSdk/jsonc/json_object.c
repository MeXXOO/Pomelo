...
/*------------------===========================--------------------------*/
/*-------------------------add 2016-10-31 by qx--------------------------*/
/*------------------===========================--------------------------*/
char json_object_object_get_int(struct json_object *obj , const char* key , int* value )
{
	json_object* valueObj = json_object_object_get( obj , key );
	if( valueObj )
	{
		*value = json_object_get_int(valueObj);
		return 1;
	}
	return 0;
}

char json_object_object_get_int64(struct json_object *obj , const char* key , int64_t* value )
{
	json_object* valueObj = json_object_object_get( obj , key );
	if( valueObj )
	{
...
const char* json_object_object_get_string( struct json_object *obj , const char* key )
{
	const char* valueStr = NULL;
	json_object* valueObj = json_object_object_get( obj , key );
	if( valueObj )	
		valueStr = json_object_get_string(valueObj);
	return valueStr;
}